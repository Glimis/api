...
export default class InputParamsTable extends React.Component {
    render() {
    	...
    	for(var i=0;i<data.length;i++){
    		...
    		html.push(<InputParamsRow dispatch={dispatch} rowdata={data[i]} row={i} edit={edit} state={state}/>)
    	}
    	html.push(<InputParamsRow dispatch={dispatch}  rowdata={['','']} row={i} edit={edit} state='active'/>)
